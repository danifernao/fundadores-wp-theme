...
<section id="articles"> <!-- Sección "Publicaciones recientes" empieza -->
    <div class="articles-inner">
        ...
        <?php
            $posts_page = new_get_page_by_title('Publicaciones'); // Obtiene la página con título "Publicaciones".
            if ( $posts_page && $has_more_posts ) {
                ?>
                <div class="articles-more">
                  <a href="<?php the_permalink( $posts_page ); ?>" class="button"><?php printf( esc_html__( 'Lee más aquí %s', 'fundadores' ), '&rarr;' ); ?></a>
